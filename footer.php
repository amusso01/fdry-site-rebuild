...
<style>
  :root {
    ...
    /* ancho de .slide */
    --slide-gap: 60px;
    /* margen total lateral por slide (30px left + 30px right) */
    --unit: calc(var(--slide-w) + var(--slide-gap));
    /* ancho real ocupado por cada slide */
    --visible: 6;
    /* cuántos logos quieres ver */
  }
  ...
  .mainfooter.menufooter li a {
    color: #A4A4A4;
  }

  .mainfooter.menufooter h3 {
    font-size: 16px;
    margin-bottom: 10px !important;
  }

  .mainfooter.menufooter ul li a:hover {
    color: #fff;
  }
