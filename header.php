...
<body data-rsssl=1 data-rsssl=1 data-rsssl=1 data-rsssl=1 data-rsssl=1 data-rsssl=1 <?php body_class(); ?>>
	...
	<style>
		.work-grid .work-box .hovereffect .overlay .work-title {
			width: 95%;
			word-wrap: break-word;
			overflow-wrap: break-word;
		}

		.work-grid .work-box .hovereffect:hover .overlay .work-title {
			width: 95%;
			word-wrap: break-word;
			overflow-wrap: break-word;
		}

		.brand .box-black .svg-brand img {
	...
	<script src="<?php echo esc_url( get_template_directory_uri() . '/mainjs/header.js?ver=' . filemtime( get_template_directory() . '/mainjs/header.js' ) ); ?>"></script>
