								...
								<div class="card">
									<ul class="ui-formSlide">
										...
										<li id="step2" data-step="2" class="">
											<div class="ui-step-content">
												<ul class="tabs">
													<li><a class="li1 active" href="#panel1">
															<div class="circle"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/typeformimg/1-type.svg"></div><span>TYPE<br>&nbsp;</span>
														</a></li>
													<div class="dashedline"></div>
													<li><a class="li2" href="#panel2">
															<div class="circle"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/typeformimg/2-business.svg"></div><span>BUSINESS<br>&nbsp;</span>
														</a></li>
													<div class="dashedline"></div>
													<li><a class="li3" href="#panel3">
															<div class="circle"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/typeformimg/3-budget.svg"></div><span>BUDGET<br>&nbsp;</span>
														</a></li>
													<div class="dashedline"></div>
													<li><a class="li1" href="#panel1">
															<div class="circle"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/typeformimg/4-details.svg"></div><span>MORE<br>DETAILS</span>
														</a></li>
													<div class="dashedline"></div>
													<li><a class="li2" href="#panel2">
															<div class="circle"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/typeformimg/5-personal.svg"></div><span>PERSONAL<br>INFORMATION</span>
														</a></li>
												</ul>
												<center>
										...
										<li id="step3" data-step="3">
											<div class="ui-step-content">
												<ul class="tabs">
													...
													<div class="dashedline"></div>
													<li><a class="li2 active" href="#panel2">
															<div class="circle"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/typeformimg/2-business.svg"></div><span>BUSINESS<br>&nbsp;</span>
														</a></li>
													<div class="dashedline"></div>
													<li><a class="li3" href="#panel3">
										...
										<li id="step4" data-step="4">
											<div class="ui-step-content">
												<ul class="tabs">
													...
													<div class="dashedline"></div>
													<li><a class="li3 active" href="#panel3">
															<div class="circle"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/typeformimg/3-budget.svg"></div><span>BUDGET<br>&nbsp;</span>
														</a></li>
													<div class="dashedline"></div>
													<li><a class="li1" href="#panel1">
