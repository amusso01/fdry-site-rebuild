		...
		<div class="container hidden-animate">
			...
			<?php if(is_page('create')) : ?>
				...
				<div class="col-md-8 offset-2 text-center">
					<h2 style="margin-bottom:15px; margin-top:25px; font-size:36px; font-weight:bold">Creative Agency</h2>
					<p style="font-size: 18px; line-height:28px;">
						FDRY is an independent creative agency, delivering brand strategy services and digital design communications. We connect brands to niche audiences ensuring we build communities, culture and add value to your commercial marketing initiatives.

						As a London Creative Agency, it is our mission to help brands engage with their audience through creative design and digital marketing pieces.

						Want to challenge old ways of thinking and add innovation to your brand? We are your team! Our approach is focused on changing perceptions with beautifully crafted creative campaigns.
					</p>

				</div>
			
			<?php elseif (is_page('build')) : ?>

				<div class="col-md-8 offset-2 text-center">
					<h2 style="margin-bottom:15px; margin-top:25px; font-size:36px; font-weight:bold">Web Design Agency</h2>
					<p style="font-size: 18px; line-height:28px;">
						FDRY is a London web design agency. Our team of web developers work across key platforms to enhance the UX and code on your website.

						Our web design software capabilities include: WordPress, Drupal, Concrete 5, Sitecore, Umbraco. Additionally, we have expert knowledge on Shopify, WooCommerce, BigCommerce, Magento and Adobe Commerce.

						Overall, we are a creative web design and development agency combining the skills of UI designers, UX designers, web designers and web developers to produce beautiful and engaging websites and e-commerce websites.
					</p>

				</div>

			<?php elseif (is_page('promote')) : ?>

				<div class="col-md-8 offset-2 text-center">
					<h2 style="margin-bottom:15px; margin-top:25px; font-size:36px; font-weight:bold">Digital Marketing Agency</h2>
					<p style="font-size: 18px; line-height:28px;">
						FDRY is one of the leading digital marketing agencies in London, specialising in Web Design, SEO, Social Media Marketing, CRO Conversion Rate Optimisation and Digital Advertising Services.

						As a London digital marketing agency experts, our approach is focused on (1) digital strategy, (2) digital and product design and development, and (3) growth marketing.

						Our holistic approach and brand building process allow us to integrate user experience research to brand activation elements, thus ensuring your brand's marketing campaign is strong and produces the expected commercial success.
					</p>
